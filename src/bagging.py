...
def train_bagging(X_train, y_train, X_valid, y_valid, X_test, y_test):
    """
    Train and evaluate a Bagging classifier with Decision Tree base estimator.
...
def run_bagging_experiments():
    ...
    for clause_count, data_size in configs:
        ...
        # Train and evaluate
        best_params, accuracy, f1 = train_bagging(X_train, y_train, X_valid, y_valid, X_test, y_test)
